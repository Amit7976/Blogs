                    ...
                    <div className="flex items-center justify-center px-4 pt-10 h-auto bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-10 col-span-4">
                        <div className="xl:w-full px-10">
                            ...
                            <div className='w-full py-6 flex justify-center-center gap-5'>
                                <p className='w-full text-center mt-4 text-gray-400'><a href="/auth/register" className='font-medium text-base justify-center flex items-center'>Already have a account<span className='font-bold text-orange-500 px-1 underline underline-offset-2 flex items-center gap-0.5 hover:text-gray-500 duration-500'>Login Now <FaAnglesRight className='text-' /></span></a></p>
                            </div>
                        </div>
                    </div>
